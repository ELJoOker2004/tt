      ...
      if (_0x43b356 == 'update_sr_id' || _0x43b356 == 'new_id') {
        ;(function () {
          ...
          _0x40f324(unsafeWindow, 'Config', async () => {
            await _0x40f324(unsafeWindow.Config, 'data', async () => {
              unsafeWindow.ConfirmView.Show(
                'ØªÙ\u2026 Ù\u2026Ù\u2020Ø\xADÙƒ Ø\xA5Ø\xB0Ù\u2020 Ø\xA7Ø\xB3ØªØ\xAEØ\xAFØ\xA7Ù\u2026 Ø\xA7Ù\u201EØ\xB3ÙƒØ\xB1Ø\xA8Øª\n            Ø\xA8Ø\xB1Ù\u2026Ø\xACØ\xA9 Ø\xA5Ø\xB3Ù\u201EØ\xA7Ù\u2026 ÙƒØ\xA7Ù\u2026Ù\u201E Ø\xB1Ø\xACØ\xA8'
              )
            })
          })
          _0x48d7fe('log', 'Init')
          ...
          _0x34dad6.onclick = async function _0x3f373d() {
            ...
            alert(
              'ÙŠØªÙ\u2026 Ø\xADØµØ\xAF Ø\xACÙ\u2026ÙŠØ\xB9 Ø\xA7Ù\u201EØ\xA3ØµØ\xAFÙ\u201AØ\xA7Ø\xA1'
            )
          }
        ...
        if (_0x43b356 == 'banned_3ars') {
          SRbtn.disabled = true
          SRbtn.textContent =
            ' ØªÙ\u2026 Ø\xADØ\xB8Ø\xB1Ùƒ - ØªÙˆØ\xA7ØµÙ\u201E Ù\u2026Ø\xB9ÙŠ Ø\xB9Ù\u201EÙ\u2030 Ù\x81ÙŠØ\xB3Ø\xA8ÙˆÙƒ Ø\xADØ\xB3Ø\xA7Ø\xA8ÙŠ Ù\u2026ÙˆØ\xABÙ\u201A : Eslam Kamel Ragab'
          localStorage.setItem('banned_3ars', Date.now() + 1728000000)
          let _0x469932 = localStorage.getItem('banned_3ars')
          if (_0x469932) {
            if (Date.now() > _0x469932) {
              localStorage.removeItem('banned_3ars')
            } else {
              setTimeout(function () {
                unsafeWindow.RefreshConfirmView.Show(
                  'ØªÙ\u2026 Ø\xADØ\xB8Ø\xB1Ùƒ Ù\u2026Ù\u2020 Ø\xA7Ø\xB3ØªØ\xAEØ\xAFØ\xA7Ù\u2026 Ø\xA7Ù\u201EØ\xB3ÙƒØ\xB1Ø\xA8Øª\nØ\xA8Ø\xB1Ù\u2026Ø\xACØ\xA9 Ø\xA5Ø\xB3Ù\u201EØ\xA7Ù\u2026 ÙƒØ\xA7Ù\u2026Ù\u201E Ø\xB1Ø\xACØ\xA8'
                )
              }, 10000)
            }
          }
